...
- **Tornei** — i tornei, una riga per partita come nel foglio Match, con i dati del torneo e del
  round ripetuti: si legge e si filtra in Excel come una tabella qualsiasi. Creato al primo
  torneo salvato.
...
| **Inserisci torneo** | Un torneo intero: data, espansione, mazzo, lista, tipologia (Local, Challenge, Sfida di lega, Amichevole), piazzamento (Vittoria, Finale, Top 4, Top 8, Altro — non in amichevole) e un numero a scelta di round. Ogni round e' al meglio di tre contro lo stesso mazzo, e ogni partita ha esito, chi ha iniziato (1°/2°), tag e note: il risultato del round si calcola da solo. Sotto, tutti i tornei salvati con modifica ed eliminazione. |
...
Ogni partita di ogni round entra anche nelle statistiche come un match singolo completo: mazzo
avversario del round, esito, 1°/2°, tag e note, con la tipologia del torneo nella colonna Torneo.
Winrate, split da primo e da secondo, tag, matchup e playbook delle note le contano insieme alle
altre, e il filtro **Torneo** le separa (per esempio: solo i Challenge). Nel foglio Match pero'
non ci sono: stanno solo nel foglio Tornei, altrimenti sarebbero contate due volte.

Se in una partita si scrivono note, tag o 1°/2° ma non l'esito, il salvataggio si ferma e lo
dice: altrimenti quei dettagli andrebbero persi in silenzio.
